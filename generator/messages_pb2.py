...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='greeter/messages.proto',
  package='example',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=b'\n\x16greeter/messages.proto\x12\x07\x65xample\")\n\x0cGreetRequest\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x0b\n\x03val\x18\x02 \x01(\x03\"<\n\rGreetResponse\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x10\n\x08greeting\x18\x02 \x01(\t\x12\x0b\n\x03val\x18\x03 \x01(\x03\"&\n\tSeenCount\x12\x0c\n\x04seen\x18\x01 \x01(\x03\x12\x0b\n\x03sum\x18\x02 \x01(\x03\x62\x06proto3'
)
...
_GREETREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='val', full_name='example.GreetRequest.val', index=1,
...
_GREETRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='val', full_name='example.GreetResponse.val', index=2,
...
_SEENCOUNT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sum', full_name='example.SeenCount.sum', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
GreetRequest = _reflection.GeneratedProtocolMessageType('GreetRequest', (_message.Message,), {
  ...
  '__module__' : 'greeter.messages_pb2'
